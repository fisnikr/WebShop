...
<body >
  ...
  <div class="col-md-offset-4" >
    <form method="POST" action="acteditcat.php">
      <h2>Select category to edit: </h2><br/>
      <div class="col-xs-4">
      <select name="select" class="form-control " value="<?php echo $row['catid'];?>" title="Choose one of the following..."  >
